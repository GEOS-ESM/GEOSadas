...
sub init {
    ...
    #-------------------------------
    $agcmIN  = "AGCM.rc.tmpl" unless $agcmIN;
    $agcmOUT = "AGCM.rc"      unless $agcmOUT;
...
OPTIONS
     -f agcm_in      name of input file (defaults to "AGCM.rc.tmpl")
     -o agcm_out     name of output file (defaults to "AGCM.rc")
     -s saverst      name of input saverst (defaults to "saverst.rc")
     -fcst           flag to indicate a forecast run
     -final          force "RECORD_FINAL: YES" in AGCM.rc file (default is "NO")
