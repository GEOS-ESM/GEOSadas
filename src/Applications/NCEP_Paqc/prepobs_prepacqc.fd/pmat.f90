...
if(ff)then
   write(41,'(" In sinvmtf; failed call to sldumf")')
   return
endif
...
if(ff)then
   write(41,'(" In dinvmtf; failed call to dldumf")')
   return
endif
...
if(ff)then
   write(41,'(" In cinvmtf; failed call to cldumf")')
   return
endif
...
call sldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In slinmmtf; failed call to sldumf")')
   return
endif
...
call dldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In dlinmmtf; failed call to dldumf")')
   return
endif
...
call cldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In clinmmtf; failed call to cldumf")')
   return
endif
...
call sldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In slinmvtf; failed call to sldumf")')
   return
endif
...
call dldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In dlinmvtf; failed call to dldumf")')
   return
endif
...
call cldumf(a,ipiv,d,ff)
if(ff)then
   write(41,'("In clinmvtf; failed call to cldumf")')
   return
endif
...
logical,               intent(  OUT):: ff
!-----------------------------------------------------------------------------
real(dp),parameter                           :: eps=1.e-1_dp
...
do i=1,m
  ...
  enddo
  if(aam == 0)then
    write(41,'("In sldumf; row ",i6," of matrix vanishes")'),i
    ff=t
    return
  endif
  s(i)=1/aam
...
!  swap rows, recording changed sign of determinant
  ...
  if(ajj == 0)then
    jm=j-1
    write(41,'(" failure in sldumf:"/" matrix singular, rank=",i3)'),jm
    ff=t
    return
  endif
  ajji=1/ajj
...
do i=1,m
  ...
  enddo
  if(aam == 0)then
    write(41,'("In dldumf;  row ",i6," of matrix vanishes")'),i
    ff=t
    return
  endif
  s(i)=1/aam
...
!  swap rows, recording changed sign of determinant
  ...
  if(ajj == 0)then
    jm=j-1
    write(41,'(" Failure in dldumf:"/" matrix singular, rank=",i3)'),jm
    ff=t
    return
  endif
  ajji=1/ajj
...
do i=1,m
  ...
  enddo
  if(aam == 0)then
    write(41,'("In cldumf;  row ",i6," of matrix vanishes")'),i
    ff=t
    return
  endif
  s(i)=1/aam
...
!  swap rows, recording changed sign of determinant
  ...
  if(ajj == c0)then
    jm=j-1
    write(41,'(" Failure in cldumf:"/" matrix singular, rank=",i3)'),jm
    ff=t
    return
  endif
  ajji=1/ajj
...
do j=1,m
  ...
  ff=(S <= 0)
  if(ff)then
     write(41,'("sL1Lmf detects nonpositive a, rank=",i6)'),jm
     return
  endif
  b(j,j)=sqrt(s)
  bjji=1/b(j,j)
...
do j=1,m
  ...
  ff=(s <= 0)
  if(ff)then
     write(41,'("dL1LMF detects nonpositive A, rank=",i6)'),jm
     return
  endif
  b(j,j)=sqrt(s)
  bjji=1/b(j,j)
...
do j=1,m
  ...
  ff=(d(j) == 0)
  if(ff)then
     write(41,'("In sldlmf; singularity of matrix detected")')
     write(41,'("Rank of matrix: ",i6)'),jm
     return
  endif
  bjji=1/d(j)
  do i=jp,m
...
do j=1,m; jm=j-1; jp=j+1
  ...
  ff=(d(j) == 0)
  if(ff)then
     write(41,'("In dldlmf; singularity of matrix detected")')
     write(41,'("Rank of matrix: ",i6)'),jm
     return
  endif
  bjji=1/d(j)
