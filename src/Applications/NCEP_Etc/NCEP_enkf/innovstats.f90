...
!==> stats for conventional + ozone obs.
  ...
  nobsps_nh  = 0;nobsps_sh  = 0;nobsps_tr  = 0;nobsps_tot= 0
  nobst_nh   = 0;nobst_sh   = 0;nobst_tr   = 0;nobst_tot=0
  nobsq_nh   = 0;nobsq_sh   = 0;nobsq_tr   = 0;nobsq_tot=0
  nobsoz_nh  = 0;nobsoz_sh  = 0;nobsoz_tr  = 0;nobsoz_tot=0
  nobswnd_nh = 0;nobswnd_sh = 0;nobswnd_tr = 0;nobswnd_tot=0
  nobspw_nh  = 0;nobspw_sh  = 0;nobspw_tr  = 0;nobspw_tot=0
  nobsgps_nh = 0;nobsgps_sh = 0;nobsgps_tr = 0;nobsgps_tot=0
  nobsaod_nh = 0;nobsaod_sh = 0;nobsaod_tr = 0;nobsaod_tot=0
  nobsspd_nh = 0;nobsspd_sh = 0;nobsspd_tr = 0;nobsspd_tot=0
  nobssat_tot=0
  ntotassim=0
  sumpsjo =0.0
  sumtjo  =0.0
...
!
  sumps_spread_nh =0.0;sumps_spread_tr =0.0;sumps_spread_sh =0.0
  sumq_spread_nh  =0.0;sumq_spread_tr  =0.0;sumq_spread_sh  =0.0
  sumt_spread_nh  =0.0;sumt_spread_tr  =0.0;sumt_spread_sh  =0.0
  sumpw_spread_nh =0.0;sumpw_spread_tr =0.0;sumpw_spread_sh =0.0
  sumaod_spread_nh=0.0;sumaod_spread_tr=0.0;sumaod_spread_sh=0.0
  sumgps_spread_nh=0.0;sumgps_spread_tr=0.0;sumgps_spread_sh=0.0
  sumspd_spread_nh=0.0;sumspd_spread_tr=0.0;sumspd_spread_sh=0.0
  sumwnd_spread_nh=0.0;sumwnd_spread_tr=0.0;sumwnd_spread_sh=0.0
  sumoz_spread_nh =0.0;sumoz_spread_tr =0.0;sumoz_spread_sh =0.0
!
  sumps_oberr_nh =0.0;sumps_oberr_tr =0.0;sumps_oberr_sh =0.0
  sumq_oberr_nh  =0.0;sumq_oberr_tr  =0.0;sumq_oberr_sh  =0.0
  sumt_oberr_nh  =0.0;sumt_oberr_tr  =0.0;sumt_oberr_sh  =0.0
  sumpw_oberr_nh =0.0;sumpw_oberr_tr =0.0;sumpw_oberr_sh =0.0
  sumaod_oberr_nh=0.0;sumaod_oberr_tr=0.0;sumaod_oberr_sh=0.0
  sumgps_oberr_nh=0.0;sumgps_oberr_tr=0.0;sumgps_oberr_sh=0.0
  sumspd_oberr_nh=0.0;sumspd_oberr_tr=0.0;sumspd_oberr_sh=0.0
  sumwnd_oberr_nh=0.0;sumwnd_oberr_tr=0.0;sumwnd_oberr_sh=0.0
  sumoz_oberr_nh =0.0;sumoz_oberr_tr =0.0;sumoz_oberr_sh =0.0
!
  biasps_nh =0.0;biasps_tr =0.0;biasps_sh =0.0
  biasq_nh  =0.0;biasq_tr  =0.0;biasq_sh  =0.0
  biast_nh  =0.0;biast_tr  =0.0;biast_sh  =0.0
  biaspw_nh =0.0;biaspw_tr =0.0;biaspw_sh =0.0
  biasaod_nh=0.0;biasaod_tr=0.0;biasaod_sh=0.0
  biasgps_nh=0.0;biasgps_tr=0.0;biasgps_sh=0.0
  biasspd_nh=0.0;biasspd_tr=0.0;biasspd_sh=0.0
  biaswnd_nh=0.0;biaswnd_tr=0.0;biaswnd_sh=0.0
  biasoz_nh =0.0;biasoz_tr =0.0;biasoz_sh =0.0
