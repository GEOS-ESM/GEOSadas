module m_diag_conv
  ...
  type diag_conv_header
    character(6),    dimension(:), allocatable :: ObsType
...
contains
  ...
  subroutine open_conv_diag(fn, conv_header,ncep)
     ...
     character(6),   dimension(maxobstype) :: cobstype
...
!     integer(i_kind) :: get_obstype_index
     character(6),intent(in)                 :: obstype
     character(6),intent(inout),dimension(*) :: obstypearr
